...
//                                    }
                ...
                case WHAT_DOWNLOAD_ERROR:
                    ...
                    tvHint.setText("Failed to load, click reload");
                    break;
            }
        }
    };
    ...
    private void init(Context context) {
        mContext = context;
        View layout = LayoutInflater.from(mContext).inflate(R.layout.view_banner_gallery, this, true);
