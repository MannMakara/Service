...
//      "Ackawi", "Acorn", "Adelost", "Affidelice au Chablis", "Afuega'l Pitu",
...
//      "Ardrahan", "Armenian String", "Aromes au Gene de Marc", "Asadero",
//      "Asiago", "Aubisque Pyrenees", "Autun", "Avaxtskyr", "Baby Swiss",
//      "Babybel", "Baguette Laonnaise", "Bakers", "Baladi", "Balaton", "Bandal",
//      "Banon", "Barry's Bay Cheddar", "Basing", "Basket Cheese", "Bath Cheese",
//      "Bavarian Bergkase", "Baylough", "Beaufort", "Beauvoorde",
...
//      "Blue Castello", "Blue Rathgore", "Blue Vein (New Zealand)",
//      "Blue Vein Cheeses", "Bocconcini", "Bocconcini (New Zealand)",
...
//      "Brebis du Lochois", "Brebis du Puyfaucon", "Bresse Bleu", "Brick",
//      "Brie", "Brie de Meaux", "Brie de Melun", "Brillat-Savarin", "Brin",
...
//      "Buffalo", "Burgos", "Butte", "Butterkase", "Button (Innes)",
...
//      "Cold Pack", "Comte", "Coolea", "Cooleney", "Coquetdale", "Corleggy",
//      "Cornish Pepper", "Cotherstone", "Cotija", "Cottage Cheese",
//      "Cottage Cheese (New Zealand)", "Cougar Gold", "Coulommiers",
//      "Coverdale", "Crayeux de Roncq", "Cream Cheese", "Cream Havarti",
//      "Crema Agria", "Crema Mexicana", "Creme Fraiche", "Crescenza", "Croghan",
//      "Crottin de Chavignol", "Crottin du Chavignol", "Crowdie", "Crowley",
...
//      "Dunsyre Blue", "Duroblando", "Durrus",
...
//      "Feta (New Zealand)", "Figue", "Filetta", "Fin-de-Siecle",
...
//      "Grand Vatel", "Grataron d' Areches", "Gratte-Paille", "Graviera",
//      "Greuilh", "Greve", "Gris de Lille", "Gruyere", "Gubbeen", "Guerbigny",
//      "Halloumi", "Halloumy (New Zealand)", "Haloumi-Style Cheese",
...
//      "Jarlsberg", "Jermi Tortes", "Jibneh Arabieh", "Jindi Brie",
//      "Jubilee Blue", "Juustoleipa", "Kadchgall", "Kaseri", "Kashta",
//      "Kefalotyri", "Kenafa", "Kernhem", "Kervella Affine", "Kikorangi",
...
//      "Le Brin", "Le Fium Orbo", "Le Lacandou", "Le Roule", "Leafield",
...
//      "Lou Pevre", "Lyonnais", "Maasdam", "Macconais", "Mahoe Aged Gouda",
//      "Mahon", "Malvern", "Mamirolle", "Manchego", "Manouri", "Manur",
//      "Marble Cheddar", "Marbled Cheeses", "Maredsous", "Margotin", "Maribo",
//      "Maroilles", "Mascares", "Mascarpone", "Mascarpone (New Zealand)",
//      "Mascarpone Torta", "Matocq", "Maytag Blue", "Meira",
//      "Menallack Farmhouse", "Menonita", "Meredith Blue", "Mesost",
//      "Metton (Cancoillotte)", "Meyer Vintage Gouda", "Mihalic Peynir",
//      "Milleens", "Mimolette", "Mine-Gabhar", "Mini Baby Bells", "Mixte",
...
//      "Mozzarella (New Zealand)", "Mozzarella di Bufala",
//      "Mozzarella Fresh, in water", "Mozzarella Rolls", "Munster", "Murol",
//      "Mycella", "Myzithra", "Naboulsi", "Nantais", "Neufchatel",
//      "Neufchatel (New Zealand)", "Niolo", "Nokkelost", "Northumberland",
//      "Oaxaca", "Olde York", "Olivet au Foin", "Olivet Bleu", "Olivet Cendre",
//      "Orkney Extra Mature Cheddar", "Orla", "Oschtjepka", "Ossau Fermier",
//      "Ossau-Iraty", "Oszczypek", "Oxford Blue", "P'tit Berrichon",
//      "Palet de Babligny", "Paneer", "Panela", "Pannerone", "Pant ys Gawn",
//      "Parmesan (Parmigiano)", "Parmigiano Reggiano", "Pas de l'Escalette",
//      "Passendale", "Pasteurized Processed", "Pate de Fromage",
...
//      "Processed Cheddar", "Provolone", "Provolone (New Zealand)",
//      "Pyengana Cheddar", "Pyramide", "Quark", "Quark (New Zealand)",
...
//      "Queso Quesadilla", "Rabacal", "Raclette", "Ragusano", "Raschera",
//      "Reblochon", "Red Leicester", "Regal de la Dombes", "Reggianito",
//      "Remedou", "Requeson", "Richelieu", "Ricotta", "Ricotta (New Zealand)",
...
//      "Scamorza", "Schabzieger", "Schloss", "Selles sur Cher", "Selva",
//      "Serat", "Seriously Strong Cheddar", "Serra da Estrela", "Sharpam",
//      "Shelburne Cheddar", "Shropshire Blue", "Siraz", "Sirene",
//      "Smoked Gouda", "Somerset Brie", "Sonoma Jack", "Sottocenare al Tartufo",
//      "Soumaintrain", "Sourire Lozerien", "Spenwood", "Sraffordshire Organic",
//      "St. Agur Blue Cheese", "Stilton", "Stinking Bishop", "String",
//      "Sussex Slipcote", "Sveciaost", "Swaledale", "Sweet Style Swiss",
//      "Swiss", "Syrian (Armenian String)", "Tala", "Taleggio", "Tamie",
//      "Tasmania Highland Chevre Log", "Taupiniere", "Teifi", "Telemea",
//      "Testouri", "Tete de Moine", "Tetilla", "Texas Goat Cheese", "Tibet",
//      "Tillamook Cheddar", "Tilsit", "Timboon Brie", "Toma", "Tomme Brulee",
//      "Tomme d'Abondance", "Tomme de Chevre", "Tomme de Romans",
//      "Tomme de Savoie", "Tomme des Chouans", "Tommes", "Torta del Casar",
...
//      "Waimata Farmhouse Blue", "Waterloo", "Weichkaese", "Wellington",
